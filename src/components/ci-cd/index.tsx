    ...
    <section className="container">
      <div className="flex flex-col overflow-hidden relative">
        ...
        <div className="w-full  md:absolute bottom-12 flex flex-col gap-6 text-center">
          ...
          <p>
            Unlock the full potential of continuous integration and delivery
            with our tailored automation solutions. Harness the collaborative
            power of GitHub and GitLab to streamline your development workflows.
            Automate your builds, tests, and deployments with Jenkins, the
