...
import { wds_ui_site_url } from "@/infrastructure/api";
...
export default async function Index({ searchParams }: { searchParams: any }) {
  ...
  return (
    <LayoutRoot>
      <NavbarRoot className="border-none bg-transparent">
        <NavbarRoot.Header>
          <NavbarRoot.Logo>WDS</NavbarRoot.Logo>
        </NavbarRoot.Header>
        <NavbarRoot.Footer>
        ...
        >
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            ...
            <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              Fast and modern React libraries to help you build your next app.
            </p>
          </div>
            ...
            <div className="relative overflow-hidden rounded-lg border bg-background p-2">
              <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                ...
                <div className="space-y-2">
                  <a href={wds_ui_site_url} className="font-bold">
                    @wds-ui
                  </a>
                  <p className="text-sm text-muted-foreground">
                    Re-usable react components built using Radix UI and Tailwind
                    CSS.
                  </p>
                </div>
              </div>
